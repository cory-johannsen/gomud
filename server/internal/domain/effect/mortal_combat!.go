...
func NewMortalCombat() *MortalCombat {
  return &MortalCombat{
    name: "Mortal Combat!",
    description: "You ignore the Pummeling and Weak Qualities when fighting with Brawling type of weapons. In addition, you may refer to [BB] or [CB] when inflicting Damage with this type of weapon, whichever is more favorable.",
  }
}
