...
func InitializeEngine() (*engine.Engine, error) {
	...
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, effectLoader, equipmentLoader, injuryLoader, inventoryLoader, jobLoader, qualityLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader, upbringingLoader)
