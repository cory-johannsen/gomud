...
func InitializeEngine() (*engine.Engine, error) {
	...
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, effectLoader, injuryLoader, jobLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader)
