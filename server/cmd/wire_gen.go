...
func InitializeEngine() (*engine.Engine, error) {
	...
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, disorderLoader, effectLoader, equipmentLoader, generatorLoader, injuryLoader, inventoryLoader, jobLoader, npcLoader, qualityLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader, upbringingLoader)
	equipment := storage.NewEquipment(database, loaders)
	npCs := storage.NewNPCs(database, loaders, equipment)
