...
func InitializeEngine() (*engine.Engine, error) {
	...
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, effectLoader, injuryLoader, inventoryLoader, jobLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader)
