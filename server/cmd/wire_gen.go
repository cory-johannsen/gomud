...
func InitializeEngine() (*engine.Engine, error) {
	...
	taskGraphLoader := loader.NewTaskGraphLoader()
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, disorderLoader, effectLoader, equipmentLoader, generatorLoader, injuryLoader, inventoryLoader, jobLoader, npcLoader, qualityLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader, upbringingLoader, actionLoader, conditionLoader, methodLoader, taskLoader, taskGraphLoader)
	...
	server := engine.NewServer(configConfig, database, players, npCs, loaders, playerGenerator, bus, clock)
