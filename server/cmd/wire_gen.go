...
func InitializeEngine() (*engine.Engine, error) {
	...
	loaders := loader.NewLoaders(appearanceLoader, alignmentLoader, archetypeLoader, backgroundLoader, jobLoader, roomLoader, skillLoader, talentLoader, traitLoader, teamLoader)
